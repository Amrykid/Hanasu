...
namespace Hanasu.ViewModel
{
    ...
    public class MainWindowViewModel : BaseViewModel
    {
        ...
        public MainWindowViewModel()
        {
            ...
            AppViewModel.MainViewModel = this;
        ...
        public bool WebControlPaneIsOpen
        {
            get { return this.GetPropertyOrDefaultType<bool>("WebControlPaneIsOpen"); }
            set { this.SetProperty(x => this.WebControlPaneIsOpen, value); }
        }

        [MessageHandler("WindowCommandWebControlRequested")]
        public void ShowWebControlFlyout(object data)
        {
            WebControlPaneIsOpen = true;
        }
        ...
        internal void PlaySelectedStation(object o)
        {
        ...
        internal void PlayStationWithDirectUrl(Station stat, string url)
        {
            if (url == null) return;
